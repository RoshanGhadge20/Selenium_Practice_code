...
public class Handling_multiple_windows 
{
	public static void main(String[] args) 
	{
		 ...
		 * driver.switchTo().window(parentwin); driver.switchTo().window(childwin);
		 */
		
		//It is more of generic way to handle it 
		while(it.hasNext())
		{
			String win_title=it.next();
			System.out.println("window title"+win_title);
		}

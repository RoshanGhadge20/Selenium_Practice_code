...
public class Get_height_and_weight_of_element
{
	public static void main(String[] args) 
	{
		...
		// Another way to get height & width of webelements
		org.openqa.selenium.Dimension sizeDimension = namefield.getSize();
		int height = sizeDimension.getHeight();
		int width = sizeDimension.getWidth();

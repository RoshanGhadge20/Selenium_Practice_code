...
import org.openqa.selenium.devtools.v120.emulation.Emulation;  // Ensure this matches the CDP version
...
public class Practice_Set1 {
    public static void main(String[] args)
    {
        ...
        devTools.send(Emulation.setDeviceMetricsOverride(
                width, height, deviceScaleFactor, isMobile, null, null, null, null, null, null, null, null, null
        ));
